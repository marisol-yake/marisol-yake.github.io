...
My name is **Marisol Yake** (she / they), I'm a member of the public that's attended undergraduate studies in biology, finance, and information science. While studying information science at CU Boulder, I was fortunate to have an opportunity to work alongside the caring folks in the [Philanthropics Informatics Research Lab (PIRL)](https://amy.voida.com/research-group/ "Link to PIRL website") as an undergraduate research assistant under the guidance of [Dr. Amy Voida](https://amy.voida.com/ "Link to Dr. Amy Voida's website") and [Dr. Shiva Darian](https://smdarian.github.io/ "Link to Dr. Shiva Darian's website"), contributing to a research manuscript exploring **how labor unions use data and information communication technologies (ICTs)** through the lenses of **Human-Computer Interactions (HCI)** and **Computer Supported Cooperative Work (CSCW)**.

I have always strived for my work to make meaningful impacts in the **lives of my neighbors** wherever I'm living. My passion for learning has always been fueled by the principle that anything I've studied or learned should be something that can go on to benefit others around me. **People before profits** every time.
