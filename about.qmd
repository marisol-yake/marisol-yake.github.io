...
::: {#hero-heading}
Marisol Yake is the Data Analyst for the **Collections and Data Analysis (CADA)** program at Mountain Museum Management (MMM), designing analytics processes to best support museum staff intervene and monitor their collections workflows, allowing for identification of increased data quality via quality-of-life changes to data work and lowering their total overhead (staff and storage) costs.
...
I always strive for my work to have lasting, mutual benefits for all of our relations. My drive for learning and research has always been fueled by the idea that everything I've learned could be something that can go on to tangibly benefit people collectively.
